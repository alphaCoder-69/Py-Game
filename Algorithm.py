...
def Cardinal():                                                         #The head function of the game 'Cardinal'
    ...
    if(user_choice != opponent):
        if((user_choice== "rock" and opponent=="paper") or (user_choice== "paper" and opponent=="scissors") or (user_choice== "scissors" and opponent=="rock")):
